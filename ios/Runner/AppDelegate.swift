...
public class SwiftFlutterMethodChannelHandler: NSObject, FlutterPlugin {
    ...
    private let duration: Double = 3.0 // Example duration of the tone in seconds
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "playBinauralBeat":
            if let args = call.arguments as? [String: Double], let frequencyLeft = args["frequencyLeft"], let frequencyRight = args["frequencyRight"] {
